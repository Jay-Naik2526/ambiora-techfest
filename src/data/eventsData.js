export const eventsData = [
    ...
    },
    {
        ...
        host: 'Coding Club',
        category: 'competition',
        description: '"Nothing is broken. Nothing is flagged. Yet something went wrong." Your curiosity is your primary weapon. You will write the scripts, query the databases, and connect the weak signals that others miss. In this investigation, there is no single "correct" answer—only the evidence you can find and the narrative you can defend. This isn’t a classroom exercise; it’s a high-stakes reconstruction of a silent disaster. You aren\'t just a student—you are the lead analyst tasked with finding the truth within a web of unordered logs, conflicting timestamps, and technical red herrings.',
        duration: '4 Hours',
        date: 'Feb 27 - March 1',
        price: 100,
